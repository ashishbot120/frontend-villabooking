...
// 1. Import the LoginModal (Adjust path if your component is in a specific subfolder like /auth)
import LoginModal from '@/app/components/login-sign'; 
// 2. Import hooks to check authentication state
...
const HomePage = () => {
  ...
  const handleSearchClick = () => {
    ...
    // If logged in, proceed with search logic
    console.log("Searching for:", { location, selectedDate, guests });
    // Add your actual search routing or API call here
  };
  ...
  return (
    <div className="min-h-screen bg-[#0a111f] text-slate-200 font-sans selection:bg-orange-500/30">
          ...
          >
            ...
            <div className="p-2">
              <button 
                ...
                className="bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-400 hover:to-amber-500 text-white rounded-full p-4 md:px-8 md:py-4 transition-all shadow-lg shadow-orange-500/25 flex items-center justify-center gap-2 transform hover:scale-105 active:scale-95"
              >
                <FiSearch size={24} />
      ...
      {/* --- AUTH MODAL --- */}
      {/* Assuming LoginModal takes isOpen and onClose props */}
      <LoginModal 
