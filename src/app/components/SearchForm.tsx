      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-start">
        ...
        <div className="relative">
          ...
          {showCalendar && (
            <div
              ref={calendarRef}
              className="absolute top-full left-0 mt-2 z-50 w-full md:w-auto"
              ...
              <div className="bg-slate-900 border border-slate-700 rounded-lg p-3 shadow-2xl">
                <DayPicker
                  ...
                  classNames={{
                    ...
                    day: 'text-white hover:bg-slate-700 rounded-md w-10 h-10 flex items-center justify-center transition-colors aria-selected:bg-orange-500 aria-selected:text-white',
