...
import { BedDouble, Bath, LayoutTemplate } from 'lucide-react'; // Updated icons
import { Villa } from '../../types'; // Import the shared Villa type

// --- THE UPDATED DARK-THEME VILLA CARD ---
...
const VillaCarousel = ({ villas }: { villas: Villa[] }) => {
  return (
    <section>
      <h2 className="text-2xl font-bold text-slate-200 mb-6">Homepage / Browse Section</h2>
      ...
      {villas.length > 0 ? (
        ...
        <p className="text-slate-400 text-center">No villas available at the moment.</p>
      )}

      <div className="text-center mt-10">
        <button className="text-slate-300 font-semibold hover:text-white transition-colors">
          Load More
        </button>
      </div>
    </section>
